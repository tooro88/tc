...
#
#  $ test/run.bash emacs-30,emacs-24 isadvice,isim,ist --batch
#     動作: 以下を順に実行するのと同じ。
#      $ test/run.bash emacs-30 isadvice --batch
#      $ test/run.bash emacs-30 isim     --batch
#      $ test/run.bash emacs-30 ist      --batch
#      $ test/run.bash emacs-24 isadvice --batch
#      $ test/run.bash emacs-24 isim     --batch
#      $ test/run.bash emacs-24 ist      --batch
#
# Windows での注意点:
